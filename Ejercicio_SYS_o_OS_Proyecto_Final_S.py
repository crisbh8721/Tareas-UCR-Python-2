#Proyecto Final: Script de mantenimiento de carpetas
#Objetivo: Combinar todo en un script que:
#1. Reciba una carpeta por argumento.
#2. Cree subcarpetas si no existen.
#3. Elimine archivos .tmp.
#4. Genere un log de actividad.
import sys
import os
